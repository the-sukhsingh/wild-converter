...
interface AudioFormatSelectorProps {
  ...
  inputFormat: AudioFormat | "unknown" | null;
  searchQuery: string;
  onSearchChange: (q: string) => void;
  onSelectFormat: (fmt: AudioFormat) => void;
}
...
export function AudioFormatSelector({
  ...
  const targetMeta = AUDIO_FORMATS[selectedFormat];
    ...
    <div className="flex flex-col gap-2">
      ...
      <div className="relative flex items-center">
        ...
        <input
          ...
          placeholder="Filter format (e.g. mp3, wav, flac, ogg, aac, opus, ls)..."
          ...
          aria-label="Filter target audio formats"
        />
        {searchQuery && (
          <button
            type="button"
