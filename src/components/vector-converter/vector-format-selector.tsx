...
interface VectorFormatSelectorProps {
  ...
  inputFormat: VectorFormat | "unknown" | null;
  searchQuery: string;
  onSearchChange: (q: string) => void;
  onSelectFormat: (fmt: VectorFormat) => void;
}
...
export function VectorFormatSelector({
  ...
  const targetMeta = VECTOR_FORMATS[selectedFormat];
    ...
    <div className="flex flex-col gap-2">
      ...
      <div className="relative flex items-center">
        ...
        <input
          ...
          placeholder="Filter format (e.g. eps, ai, dxf, pdf, png, webp, ls)..."
          ...
          aria-label="Filter target vector formats"
        />
        {searchQuery && (
          <button
            type="button"
          ...
          return (
            ...
            >
              ...
              {isLossless && (
                ...
                >
                  {fmt.category === "rasterize" ? "Raster" : "LS"}
                </span>
              )}
            </button>
          );
