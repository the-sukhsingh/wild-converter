...
interface VideoFormatSelectorProps {
  ...
  inputFormat: VideoFormat | "unknown" | null;
  searchQuery: string;
...
export function VideoFormatSelector({
  ...
  const targetMeta = VIDEO_FORMATS[selectedFormat];
    ...
    <div className="flex flex-col gap-2">
      ...
      <div className="relative flex items-center">
        ...
        <input
          ...
          placeholder="Filter format (e.g. mp4, webm, gif, mkv, mov, wav, ls)..."
          ...
          aria-label="Filter target video formats"
        />
        {searchQuery && (
          <button
            type="button"
          ...
          return (
            ...
            >
              ...
              {isLossless && (
                ...
                >
                  {fmt.category === "audio-extract" ? "Audio" : "LS"}
                </span>
              )}
            </button>
          );
