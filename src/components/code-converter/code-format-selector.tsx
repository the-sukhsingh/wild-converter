...
interface CodeFormatSelectorProps {
  ...
  inputFormat: CodeFormat | "unknown" | null;
  searchQuery: string;
  onSearchChange: (q: string) => void;
  onSelectFormat: (fmt: CodeFormat) => void;
}
...
export function CodeFormatSelector({
  ...
  const targetMeta = CODE_FORMATS[selectedFormat];
    ...
    <div className="flex flex-col gap-2">
      ...
      <div className="relative flex items-center">
        ...
        <input
          ...
          placeholder="Filter format (e.g. ts, js, py, rust, go, html, css, json, yaml, sql, ls)..."
          ...
          aria-label="Filter target code formats"
        />
        {searchQuery && (
          <button
            type="button"
